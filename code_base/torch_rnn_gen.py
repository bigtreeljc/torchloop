...
print("all_letters are {}".format(all_letters))
...
for filename in findFiles(os.path.join(data_dir, 'names/*.txt')):
    path, category_file = os.path.split(filename)
...
print("n_categories: {}, all_categories {}".format(n_categories, all_categories))
...
# second letter to eos for target 
def targetTensor(line):
    letter_indexes = [all_letters.find(line[li]) \
